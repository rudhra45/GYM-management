...
public class registerController1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement ps = c.prepareStatement("INSERT INTO login1 (email, pass) VALUES (?, ?)");
            ps.setString(1, un);
            ps.setString(2, pw);
            ...
            if (rowsAffected > 0) {
                ...
                out.println("window.location.href='index1.html';");
                out.println("</script>");
            } else {
                // Registration failed
                response.sendRedirect("error1.html"); // Redirect to error page
            }
            c.close();
